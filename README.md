...
Все задачи, связанные с администрированием системы Unix. Некоторые из них были протестированы на виртуальной машине Debian и не могли быть выполнены на macos. Этот проект был завершен 5 декабря 2020 года и оценен на 100 баллов. Задание: [`init.en.pdf`](resources/init.en.pdf).
